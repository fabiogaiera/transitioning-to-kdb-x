...
from intraday_trading_volumes.volumes_dataset_creator import create_dataset
from intraday_trading_volumes.volumes_histogram_creator import create_histogram

"""
Usage in Linux / Mac:
python -m intraday_trading_volumes.volumes_script /path/to/file/trades.csv 2025-06-06

Usage in Windows:
python -m intraday_trading_volumes.volumes_script C:/path/to/file/trades.csv 2025-06-06
"""
